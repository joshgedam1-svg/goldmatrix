...
$tabs = [
    ...
    'showcase'     => ['label' => 'Feature Showcase',   'icon' => 'bi-window-stack',          'badge' => count($showcase_items ?? []) ?: '3'],
...
<div class="container-fluid px-0">
  ...
  <?php /* ══════════════════════════════════════════════════
          TAB: FEATURE SHOWCASE (2-COLUMN CARDS)
          ══════════════════════════════════════════════════ */
  elseif ($activeTab === 'showcase'): ?>
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
            <h5 class="card-title fw-bold mb-0">
              <i class="bi bi-gear-fill text-warning me-2"></i>Showcase Section Settings
            </h5>
            <span class="badge bg-primary-subtle text-primary border px-2 py-1">Global Header</span>
          </div>
          <div class="card-body p-4">
            <form method="POST" action="/admin/homepage?tab=showcase">
              <?= csrf_field() ?>
              <input type="hidden" name="action" value="save_showcase_settings">

              <!-- Enable/Disable Switch -->
              <div class="form-check form-switch mb-3 p-3 bg-light rounded-3 border">
                <input class="form-check-input ms-0 me-2" type="checkbox" name="showcase_enabled" value="1" id="showcaseEnabled" <?= ($showcase_enabled ?? '1') == '1' ? 'checked' : '' ?>>
                <label class="form-check-label fw-bold text-dark fs-13" for="showcaseEnabled">
                  Enable Feature Showcase Section on Homepage
                </label>
                <div class="fs-11 text-muted mt-1">If turned off, this entire section will be hidden on the live website.</div>
              </div>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="showcase_badge" value="<?= e($showcase_badge ?? '') ?>" class="form-control fw-bold fs-13" placeholder="e.g. POWERFUL FEATURES">
                </div>

                <!-- Main Heading -->
                <div class="col-md-4">
                  <label class="form-label fw-semibold fs-12 text-secondary">Main Section Heading <span class="text-danger">*</span></label>
                  <input type="text" name="showcase_title" value="<?= e($showcase_title ?? 'The only software for Jewelry business') ?>" class="form-control fw-bold fs-13" placeholder="The only software for Jewelry business" required>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="showcase_title_highlight" value="<?= e($showcase_title_highlight ?? 'Jewelry business') ?>" class="form-control fw-bold fs-13 text-warning border-warning" placeholder="Jewelry business">
                ...
                <div class="col-12">
                  ...
                  <textarea name="showcase_desc" rows="2" class="form-control fs-13" placeholder="Explore top-tier tools designed specifically for modern jewellery businesses..."><?= e($showcase_desc ?? '') ?></textarea>
                </div>
              </div>
    ...
    <!-- 2. REPEATABLE FEATURE SHOWCASE CARDS -->
    <div class="card border-0 shadow-sm mb-4">
      <div class="card-header bg-white py-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
        <div>
          <h5 class="card-title fw-bold mb-0">
            <i class="bi bi-collection-play-fill text-primary me-2"></i>Showcase Feature Cards
          </h5>
          <p class="text-muted fs-12 mb-0">Manage individual feature showcase cards, UI mockups, and micro-feature badges.</p>
        </div>
        <button class="btn btn-gold btn-sm d-inline-flex align-items-center gap-1 fw-bold shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#addShowcaseCollapse" aria-expanded="false">
          <i class="bi bi-plus-lg"></i>
          <span>+ Add New Feature Card</span>
        </button>
      </div>

      <!-- COLLAPSIBLE: ADD NEW FEATURE CARD FORM -->
      <div class="collapse border-bottom bg-light" id="addShowcaseCollapse">
        <div class="card-body p-4">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <h6 class="fw-bold text-dark mb-0">
              <i class="bi bi-plus-circle-fill text-success me-2"></i>Create New Feature Showcase Card
            </h6>
            <button type="button" class="btn-close" data-bs-toggle="collapse" data-bs-target="#addShowcaseCollapse"></button>
          </div>

          <form method="POST" action="/admin/homepage?tab=showcase" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <input type="hidden" name="action" value="add_showcase_item">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-7">
                <div class="row g-2 mb-3">
                  <div class="col-md-6">
                    <label class="form-label fs-12 fw-semibold text-secondary">Card Eyebrow / Subtitle</label>
                    <input type="text" name="subtitle" class="form-control form-control-sm" placeholder="e.g. Gain Complete Clarity">
                  </div>
                  <div class="col-md-6">
                    <label class="form-label fs-12 fw-semibold text-secondary">Sort Order</label>
                    <input type="number" name="sort_order" class="form-control form-control-sm" value="<?= count($showcase_items ?? []) + 1 ?>">
                  </div>
                </div>

                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Feature Card Title <span class="text-danger">*</span></label>
                  <input type="text" name="title" class="form-control fw-bold" placeholder="e.g. Transaction Reports" required>
                </div>

                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Short Description</label>
                  <textarea name="description" rows="2" class="form-control fs-13" placeholder="Track all your financial transactions with detailed reports and real-time analytics."></textarea>
                </div>

                <!-- 3 MICRO-FEATURE HIGHLIGHT BADGES -->
                <div class="p-3 bg-white rounded-3 border mb-3">
                  <label class="form-label fs-12 fw-bold text-dark mb-2">
                    <i class="bi bi-check2-all text-success me-1"></i>3 Bottom Micro-Feature Highlights
                  </label>
                  <div class="row g-2 mb-2">
                    <div class="col-4">
                      <input type="text" name="feat_title[]" class="form-control form-control-sm fw-bold" placeholder="1. Real-time Analytics">
                    </div>
                    <div class="col-5">
                      <input type="text" name="feat_desc[]" class="form-control form-control-sm" placeholder="Live tracking">
                    </div>
                    <div class="col-3">
                      <input type="text" name="feat_icon[]" class="form-control form-control-sm" value="bi-graph-up-arrow" placeholder="Icon Class">
                    </div>
                  </div>
                  <div class="row g-2 mb-2">
                    <div class="col-4">
                      <input type="text" name="feat_title[]" class="form-control form-control-sm fw-bold" placeholder="2. Export Reports">
                    </div>
                    <div class="col-5">
                      <input type="text" name="feat_desc[]" class="form-control form-control-sm" placeholder="Download formats">
                    </div>
                    <div class="col-3">
                      <input type="text" name="feat_icon[]" class="form-control form-control-sm" value="bi-download" placeholder="Icon Class">
                    </div>
                  </div>
                  <div class="row g-2">
                    <div class="col-4">
                      <input type="text" name="feat_title[]" class="form-control form-control-sm fw-bold" placeholder="3. Smart Filters">
                    </div>
                    <div class="col-5">
                      <input type="text" name="feat_desc[]" class="form-control form-control-sm" placeholder="Find data quickly">
                    </div>
                    <div class="col-3">
                      <input type="text" name="feat_icon[]" class="form-control form-control-sm" value="bi-funnel" placeholder="Icon Class">
                    </div>
                  </div>
                </div>
                ...
                <div class="row g-2">
                  <div class="col-6">
                    <label class="form-label fs-12 fw-semibold text-secondary">Optional Button Text</label>
                    <input type="text" name="btn1_text" class="form-control form-control-sm" placeholder="e.g. Explore Reports">
                  </div>
                  <div class="col-6">
                    <label class="form-label fs-12 fw-semibold text-secondary">Button Link / URL</label>
                    <input type="text" name="btn1_link" class="form-control form-control-sm" placeholder="#contact">
                  </div>
                </div>
              </div>

              <!-- RIGHT COLUMN: Visuals, Icons & Accent Color -->
              <div class="col-md-5">
                <!-- Main Feature Image Upload -->
                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Dashboard / Product Mockup Image</label>
                  <input type="file" name="image" accept=".webp,.png,.jpg,.jpeg,.svg,image/webp,image/png,image/jpeg" class="form-control form-control-sm">
                  <div class="fs-11 text-muted mt-1">Recommended: WebP / Transparent PNG / JPG (approx 1200×800px).</div>
                </div>

                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Image Alt Text (SEO)</label>
                  <input type="text" name="alt_text" class="form-control form-control-sm" placeholder="e.g. Transaction Reports Dashboard">
                </div>

                <!-- Accent Color Selector -->
                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">
                    <i class="bi bi-palette-fill text-warning me-1"></i>Theme &amp; Accent Color
                  </label>
                  <div class="d-flex align-items-center gap-2">
                    <input type="color" name="accent_color" class="form-control form-control-color form-control-sm" value="#DC9423" id="addShowcaseAccent" style="width:42px;height:32px;cursor:pointer;">
                    <input type="text" id="addShowcaseHex" class="form-control form-control-sm font-monospace" value="#DC9423" style="max-width:95px;" oninput="document.getElementById('addShowcaseAccent').value=this.value">
                    <div class="d-flex gap-1 flex-wrap align-items-center">
                      <button type="button" class="btn btn-sm p-0 rounded-circle border shadow-sm" style="width:22px;height:22px;background:#DC9423;" title="Luxury Gold" onclick="setAccent('#DC9423','addShowcaseAccent','addShowcaseHex')"></button>
                      <button type="button" class="btn btn-sm p-0 rounded-circle border shadow-sm" style="width:22px;height:22px;background:#8B5CF6;" title="Purple" onclick="setAccent('#8B5CF6','addShowcaseAccent','addShowcaseHex')"></button>
                      <button type="button" class="btn btn-sm p-0 rounded-circle border shadow-sm" style="width:22px;height:22px;background:#3B82F6;" title="Sapphire Blue" onclick="setAccent('#3B82F6','addShowcaseAccent','addShowcaseHex')"></button>
                      <button type="button" class="btn btn-sm p-0 rounded-circle border shadow-sm" style="width:22px;height:22px;background:#10B981;" title="Emerald Green" onclick="setAccent('#10B981','addShowcaseAccent','addShowcaseHex')"></button>
                      <button type="button" class="btn btn-sm p-0 rounded-circle border shadow-sm" style="width:22px;height:22px;background:#001540;" title="GoldMatrix Navy" onclick="setAccent('#001540','addShowcaseAccent','addShowcaseHex')"></button>
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Card Header Icon (Bootstrap Icon Class)</label>
                  <div class="input-group input-group-sm">
                    <span class="input-group-text"><i class="bi bi-star"></i></span>
                    <input type="text" name="icon" class="form-control" value="bi-bar-chart-fill" placeholder="e.g. bi-bar-chart-fill">
                  </div>
                  <div class="fs-11 text-muted mt-1">Examples: <code>bi-bar-chart-fill</code>, <code>bi-person-fill</code>, <code>bi-shield-check</code>, <code>bi-cpu-fill</code></div>
                </div>

                <!-- Status -->
                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Publish Status</label>
                  <select name="is_active" class="form-select form-select-sm">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-2 border-top">
              <button type="button" class="btn btn-light btn-sm px-3" data-bs-toggle="collapse" data-bs-target="#addShowcaseCollapse">Cancel</button>
              <button type="submit" class="btn btn-gold btn-sm px-4 fw-bold">
                <i class="bi bi-plus-circle me-1"></i> Save &amp; Add Feature Card
              </button>
            </div>
          </form>
        </div>
      ...
      <!-- SHOWCASE CARDS TABLE LIST -->
      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
          <thead class="table-light fs-12 text-uppercase text-secondary">
            <tr>
              <th style="width:50px;">#</th>
              <th style="width:130px;">UI Mockup</th>
              <th>Feature Title &amp; Description</th>
              <th>3 Micro-Highlights</th>
              <th style="width:100px;">Status</th>
              <th style="width:180px;" class="text-end">Actions</th>
            </tr>
          </thead>
            ...
            <?php if (empty($showcase_items)): ?>
              <tr>
                <td colspan="6" class="text-center py-5 text-muted">
                  <i class="bi bi-window-stack fs-2 d-block mb-2 text-warning"></i>
                  <div class="fw-bold">No feature showcase cards found.</div>
                  <p class="fs-12 mb-0">Click <strong>"+ Add New Feature Card"</strong> above to create your first card.</p>
                </td>
              </tr>
            <?php else: ?>
              <?php foreach ($showcase_items as $idx => $card): 
                $feats = !empty($card['features']) ? json_decode($card['features'], true) : [];
                $accent = !empty($card['accent_color']) ? $card['accent_color'] : '#DC9423';
              ?>
                <tr>
                  <td class="fw-bold text-muted"><?= $idx + 1 ?></td>
                  <td>
                    <?php if (!empty($card['image'])): ?>
                      <div class="position-relative d-inline-block">
                        <img src="<?= e($card['image']) ?>" alt="<?= e($card['title']) ?>" class="rounded border shadow-sm" style="width:95px;height:58px;object-fit:cover;background:#000B2A;">
                        <form method="POST" action="/admin/homepage?tab=showcase" class="position-absolute top-0 end-0" onsubmit="return confirm('Remove mockup image for this card?');">
                          <?= csrf_field() ?>
                          <input type="hidden" name="action" value="remove_showcase_image">
                    ...
                    <?php else: ?>
                      <div class="rounded text-center d-flex align-items-center justify-content-center border" style="width:95px;height:58px;background:#000B2A;">
                        <i class="bi <?= e($card['icon'] ?: 'bi-image') ?>" style="color:<?= e($accent) ?>;font-size:22px;"></i>
                      </div>
                    <?php endif; ?>
                  </td>
                  <td>
                    <div class="d-flex align-items-center gap-1 mb-1">
                      <span class="badge rounded-pill" style="background:<?= e($accent) ?>; color:#000; font-size:10px; font-weight:700;">
                        <i class="bi <?= e($card['icon'] ?: 'bi-check') ?> me-1"></i><?= e($card['subtitle'] ?: 'Feature') ?>
                      </span>
                    </div>
                    <div class="fw-bold text-dark fs-13"><?= e($card['title']) ?></div>
                    <div class="text-muted fs-11 text-truncate" style="max-width:320px;"><?= e($card['description']) ?></div>
                  </td>
                  <td>
                      ...
                      <?php if (!empty($feats) && is_array($feats)): ?>
                        <?php foreach ($feats as $f): ?>
                          <span class="badge bg-light text-dark border text-start fs-10 text-truncate">
                            <i class="bi <?= e($f['icon'] ?? 'bi-check2') ?> text-warning me-1"></i>
                            <strong><?= e($f['title'] ?? '') ?></strong>: <?= e($f['desc'] ?? '') ?>
                          </span>
                        <?php endforeach; ?>
                      <?php else: ?>
                  ...
                  <td>
                    <form method="POST" action="/admin/homepage?tab=showcase">
                      <?= csrf_field() ?>
                      <input type="hidden" name="action" value="toggle_showcase_item">
                      <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                      <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent" title="Click to Toggle">
                        ...
                        <?php else: ?>
                          <span class="badge bg-secondary-subtle text-secondary border px-2 py-1">Disabled</span>
                        <?php endif; ?>
                      </button>
                    </form>
                  </td>
                  <td class="text-end">
                    <div class="d-flex justify-content-end gap-1">
                      <!-- Edit Modal Button -->
                      <button type="button" class="btn btn-light btn-sm border text-primary" data-bs-toggle="modal" data-bs-target="#editShowcaseModal<?= $card['id'] ?>" title="Edit Card">
                        <i class="bi bi-pencil-square"></i>
                      </button>

                      <!-- Delete Button -->
                      <form method="POST" action="/admin/homepage?tab=showcase" onsubmit="return confirm('Are you sure you want to delete this feature card?');" class="d-inline">
                        <?= csrf_field() ?>
                        <input type="hidden" name="action" value="delete_showcase_item">
                        <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                        <button type="submit" class="btn btn-light btn-sm border text-danger" title="Delete Card">
                    ...
                    <!-- EDIT SHOWCASE MODAL -->
                    <div class="modal fade text-start" id="editShowcaseModal<?= $card['id'] ?>" tabindex="-1" aria-hidden="true">
                      <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg">
                          <div class="modal-header bg-navy text-white">
                            <h6 class="modal-title fw-bold text-white">
                              <i class="bi bi-pencil-square text-warning me-2"></i>Edit Feature Card: <?= e($card['title']) ?>
                            </h6>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                          </div>
                          <form method="POST" action="/admin/homepage?tab=showcase" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <input type="hidden" name="action" value="update_showcase_item">
                            <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                            ...
                            <div class="modal-body p-4">
                              <div class="row g-3">
                                ...
                                <div class="col-12">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Short Description</label>
                                  <textarea name="description" rows="2" class="form-control fs-13"><?= e($card['description'] ?? '') ?></textarea>
                                </div>

                                <!-- Accent Color & Icon -->
                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Accent Color</label>
                                  <div class="d-flex align-items-center gap-2">
                                    <input type="color" name="accent_color" class="form-control form-control-color form-control-sm" value="<?= e($accent) ?>" id="editShowcaseAccent<?= $card['id'] ?>" style="width:42px;height:32px;cursor:pointer;">
                                    <input type="text" id="editShowcaseHex<?= $card['id'] ?>" class="form-control form-control-sm font-monospace" value="<?= e($accent) ?>" style="max-width:95px;" oninput="document.getElementById('editShowcaseAccent<?= $card['id'] ?>').value=this.value">
                                  </div>
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Header Icon Class</label>
                                  <input type="text" name="icon" value="<?= e($card['icon'] ?? 'bi-bar-chart-fill') ?>" class="form-control form-control-sm">
                                </div>

                                <!-- 3 Micro Features -->
                                <div class="col-12">
                                  <div class="p-3 bg-light rounded-3 border">
                                    <label class="form-label fs-12 fw-bold text-dark mb-2">3 Bottom Micro-Feature Highlights</label>
                                    <?php for ($fi = 0; $fi < 3; $fi++): 
                                      $fItem = $feats[$fi] ?? ['title' => '', 'desc' => '', 'icon' => 'bi-check2-circle'];
                                    ?>
                                      <div class="row g-2 mb-2">
                                        <div class="col-4">
                                          <input type="text" name="feat_title[]" value="<?= e($fItem['title'] ?? '') ?>" class="form-control form-control-sm fw-bold" placeholder="Title <?= $fi + 1 ?>">
                                        </div>
                                        <div class="col-5">
                                          <input type="text" name="feat_desc[]" value="<?= e($fItem['desc'] ?? '') ?>" class="form-control form-control-sm" placeholder="Description <?= $fi + 1 ?>">
                                        </div>
                                        <div class="col-3">
                                          <input type="text" name="feat_icon[]" value="<?= e($fItem['icon'] ?? 'bi-check2-circle') ?>" class="form-control form-control-sm" placeholder="Icon class">
                                        </div>
                                      </div>
                                    <?php endfor; ?>
                                  </div>
                                ...
                                <div class="col-12">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Replace / Upload Mockup Image</label>
                                  <?php if (!empty($card['image'])): ?>
                                    <div class="d-flex align-items-center gap-3 mb-2 p-2 bg-light rounded border">
                                      <img src="<?= e($card['image']) ?>" alt="Mockup" style="width:70px;height:45px;object-fit:cover;background:#000B2A;" class="rounded border">
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="remove_showcase_image" value="1" id="remShowcaseImg<?= $card['id'] ?>">
                                        <label class="form-check-label text-danger fs-12 fw-bold" for="remShowcaseImg<?= $card['id'] ?>">
                                          Delete this image
                                        </label>
                                      </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Optional Button Text</label>
                                  <input type="text" name="btn1_text" value="<?= e($card['btn1_text'] ?? '') ?>" class="form-control form-control-sm">
                                </div>
                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Button URL</label>
                                  <input type="text" name="btn1_link" value="<?= e($card['btn1_link'] ?? '') ?>" class="form-control form-control-sm">
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Image Alt Text (SEO)</label>
                                  <input type="text" name="alt_text" value="<?= e($card['alt_text'] ?? '') ?>" class="form-control form-control-sm">
                                </div>
                                <div class="col-md-6">
                                  <label class="form-label fs-12 fw-semibold text-secondary">Publish Status</label>
                                  <select name="is_active" class="form-select form-select-sm">
                            ...
                            <div class="modal-footer bg-light py-2">
                              ...
                              <button type="submit" class="btn btn-gold btn-sm fw-bold px-4">
                                <i class="bi bi-check2-circle me-1"></i> Update Feature Card
                              </button>
                            </div>
                          </form>
                        </div>
  ...
  <?php /* ══════════════════════════════════════════════════
          TAB: POWERFUL FEATURES (5-CARD PHOTO GRID)
          ══════════════════════════════════════════════════ */
  elseif ($activeTab === 'pfeatures'): ?>
    ...
    <div class="row g-4 mb-4">
      <div class="col-12">
        <div class="card border-0 shadow-sm">
          <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
            <h5 class="card-title fw-bold mb-0">
              <i class="bi bi-grid-1x2-fill text-primary me-2"></i>Powerful Features (5-Card Grid) Settings
            </h5>
            <span class="badge bg-warning-subtle text-dark border px-2 py-1">Directly Below Trust Bar</span>
          </div>
          <div class="card-body p-4">
            <form method="POST" action="/admin/homepage?tab=pfeatures">
              <?= csrf_field() ?>
              <input type="hidden" name="action" value="save_pfeat_settings">

              <!-- Enable/Disable Switch -->
              <div class="form-check form-switch mb-3 p-3 bg-light rounded-3 border">
                <input class="form-check-input ms-0 me-2" type="checkbox" name="pfeat_enabled" value="1" id="pfeatEnabled" <?= ($pfeat_enabled ?? '1') == '1' ? 'checked' : '' ?>>
                <label class="form-check-label fw-bold text-dark fs-13" for="pfeatEnabled">
                  Enable Powerful Features (5-Card Grid) Section on Homepage
                </label>
                <div class="fs-11 text-muted mt-1">Displayed directly below the Trust Bar flags.</div>
              </div>
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="pfeat_badge" value="<?= e($pfeat_badge ?? 'POWERFUL FEATURES') ?>" class="form-control fw-bold fs-13" placeholder="POWERFUL FEATURES">
                </div>

                <!-- Main Heading -->
                <div class="col-md-8">
                  <label class="form-label fw-semibold fs-12 text-secondary">Main Section Heading <span class="text-danger">*</span></label>
                  <input type="text" name="pfeat_title" value="<?= e($pfeat_title ?? 'An Easy-To-Use Cloud Based Jewelry ERP Software') ?>" class="form-control fw-bold fs-13" required>
                </div>

                <!-- Description -->
                <div class="col-12">
                  <label class="form-label fw-semibold fs-12 text-secondary">Section Subtitle / Description</label>
                  <textarea name="pfeat_desc" rows="2" class="form-control fs-13"><?= e($pfeat_desc ?? '') ?></textarea>
                </div>

                <!-- Bottom Button -->
                <div class="col-md-6">
                  <label class="form-label fw-semibold fs-12 text-secondary">Bottom CTA Button Text</label>
                  <input type="text" name="pfeat_cta_text" value="<?= e($pfeat_cta_text ?? 'Explore All Features →') ?>" class="form-control fs-13">
                </div>
                <div class="col-md-6">
                  <label class="form-label fw-semibold fs-12 text-secondary">Bottom CTA Link</label>
                  <input type="text" name="pfeat_cta_link" value="<?= e($pfeat_cta_link ?? '#modules') ?>" class="form-control fs-13">
                </div>
              </div>
    ...
    <!-- 2. REPEATABLE 5-CARD GRID MANAGER -->
    <div class="card border-0 shadow-sm mb-4">
      <div class="card-header bg-white py-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
        <div>
          <h5 class="card-title fw-bold mb-0">
            <i class="bi bi-collection-play text-warning me-2"></i>Feature Cards (<?= count($pfeat_items ?? []) ?>)
          </h5>
          <p class="text-muted fs-12 mb-0">Manage top hero photo, circular gold icon, title, description, and link for each card.</p>
        </div>
        <button class="btn btn-gold btn-sm d-inline-flex align-items-center gap-1 fw-bold shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#addPfeatCollapse" aria-expanded="false">
          <i class="bi bi-plus-lg"></i>
          <span>+ Add New Feature Card</span>
        </button>
      </div>

      <!-- COLLAPSIBLE: ADD NEW FEATURE CARD -->
      <div class="collapse border-bottom bg-light" id="addPfeatCollapse">
        <div class="card-body p-4">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <h6 class="fw-bold text-dark mb-0">
              <i class="bi bi-plus-circle-fill text-success me-2"></i>Create New Feature Card
            </h6>
            <button type="button" class="btn-close" data-bs-toggle="collapse" data-bs-target="#addPfeatCollapse"></button>
          </div>

          <form method="POST" action="/admin/homepage?tab=pfeatures" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <input type="hidden" name="action" value="add_pfeat_item">
            ...
            <div class="row g-3">
              <div class="col-md-7">
                <div class="row g-2 mb-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="title" class="form-control fw-bold" placeholder="e.g. Accounts Management" required>
                  </div>
                  <div class="col-md-3">
                    <label class="form-label fs-12 fw-semibold text-secondary">Bootstrap Icon</label>
                    <input type="text" name="icon" class="form-control" placeholder="bi-calculator" value="bi-box-seam">
                  </div>
                  <div class="col-md-3">
                    <label class="form-label fs-12 fw-semibold text-secondary">Sort Order</label>
                    <input type="number" name="sort_order" class="form-control" value="<?= count($pfeat_items ?? []) + 1 ?>">
                  </div>
                </div>

                <div class="mb-3">
                  <label class="form-label fs-12 fw-semibold text-secondary">Short Description <span class="text-danger">*</span></label>
                  <textarea name="description" rows="3" class="form-control fs-13" placeholder="Manage financial records, ledgers..." required></textarea>
                </div>
                ...
                <div class="row g-2">
                  ...
                  <div class="col-md-6">
                    <label class="form-label fs-12 fw-semibold text-secondary">Image Alt Text (SEO)</label>
                    <input type="text" name="alt_text" class="form-control form-control-sm" placeholder="e.g. Accounts Management">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-5">
                <div class="p-3 bg-white rounded-3 border h-100 d-flex flex-column justify-content-between">
                  <div>
                    <label class="form-label fs-12 fw-bold text-dark mb-2">
                      <i class="bi bi-image text-primary me-1"></i>Card Top Photo Upload
                    </label>
                    <div class="image-upload-dropzone p-3 text-center border rounded-3 bg-light mb-2">
                      <i class="bi bi-cloud-arrow-up-fill text-secondary fs-2"></i>
                      <div class="fs-12 text-muted mt-1">Upload high-res photo</div>
                      <input type="file" name="image" accept="image/*" class="form-control form-control-sm mt-2">
                    </div>
                    <div class="mb-2">
                  ...
                  <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                    <button type="button" class="btn btn-light btn-sm" data-bs-toggle="collapse" data-bs-target="#addPfeatCollapse">Cancel</button>
                    <button type="submit" class="btn btn-navy btn-sm px-4 fw-bold">Save Card</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
          ...
          <tbody class="fs-13">
            <?php if (empty($pfeat_items)): ?>
              <tr>
                <td colspan="7" class="text-center py-5 text-muted">
                  <i class="bi bi-grid-1x2 fs-2 d-block mb-2 text-warning"></i>
                  <div class="fw-bold">No feature cards found.</div>
                  <p class="fs-12 mb-0">Click <strong>"+ Add New Feature Card"</strong> above to create your first card.</p>
                </td>
              </tr>
            <?php else: ?>
              <?php foreach ($pfeat_items as $idx => $card): ?>
                <tr>
                  <td class="fw-bold text-muted"><?= $idx + 1 ?></td>
                  <td>
                    <?php if (!empty($card['image'])): ?>
                      <div class="position-relative d-inline-block">
                        <img src="<?= e($card['image']) ?>" alt="<?= e($card['title']) ?>" class="rounded border shadow-sm" style="width:85px;height:52px;object-fit:cover;">
                        <form method="POST" action="/admin/homepage?tab=pfeatures" class="position-absolute top-0 end-0" onsubmit="return confirm('Remove photo for this card?');">
                          <?= csrf_field() ?>
                          <input type="hidden" name="action" value="remove_pfeat_image">
                          <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                          <button type="submit" class="btn btn-danger btn-sm p-0 rounded-circle d-flex align-items-center justify-content-center shadow" style="width:18px;height:18px;transform:translate(30%, -30%);" title="Remove Photo">
                            <i class="bi bi-x" style="font-size:11px;"></i>
                          </button>
                        </form>
                      </div>
                    <?php else: ?>
                      <div class="rounded text-center d-flex align-items-center justify-content-center border text-muted" style="width:85px;height:52px;background:#001540;">
                        <i class="bi bi-image text-warning fs-5"></i>
                      </div>
                    <?php endif; ?>
                  </td>
                  <td>
                    <div class="rounded-circle d-flex align-items-center justify-content-center border" style="width:36px;height:36px;background:#001540;border-color:#DC9423 !important;">
                      <i class="bi <?= e($card['icon'] ?: 'bi-star') ?>" style="color:#DC9423;font-size:16px;"></i>
                    </div>
                  </td>
                  <td>
                    <div class="fw-bold text-dark fs-14"><?= e($card['title']) ?></div>
                  ...
                  <td>
                    <span class="badge bg-light text-dark border"><?= e($card['link'] ?: '#contact') ?></span>
                  </td>
                  <td>
                    <form method="POST" action="/admin/homepage?tab=pfeatures">
                      <?= csrf_field() ?>
                      <input type="hidden" name="action" value="toggle_pfeat_item">
                      <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                      <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent" title="Click to Toggle">
                        <?php if ($card['is_active']): ?>
                          <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1 cursor-pointer">Active</span>
                  ...
                  <td class="text-end pe-3">
                    <div class="btn-group btn-group-sm">
                      <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editPfeatModal<?= $card['id'] ?>">
                        <i class="bi bi-pencil-fill"></i>
                      </button>
                      <form method="POST" action="/admin/homepage?tab=pfeatures" onsubmit="return confirm('Delete this feature card?');" class="d-inline">
                        <?= csrf_field() ?>
                        <input type="hidden" name="action" value="delete_pfeat_item">
                        <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
                        <button type="submit" class="btn btn-outline-danger">
                          <i class="bi bi-trash3-fill"></i>
                        </button>
                    ...
                    <!-- EDIT MODAL -->
                    <div class="modal fade" id="editPfeatModal<?= $card['id'] ?>" tabindex="-1">
                      <div class="modal-dialog modal-lg modal-dialog-centered text-start">
                        <div class="modal-content border-0 shadow">
                          <div class="modal-header bg-navy text-white">
                            <h6 class="modal-title fw-bold text-white">
                          ...
                          <form method="POST" action="/admin/homepage?tab=pfeatures" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <input type="hidden" name="action" value="update_pfeat_item">
                            <input type="hidden" name="item_id" value="<?= $card['id'] ?>">
